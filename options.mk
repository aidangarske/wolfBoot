...
ifeq ($(SIGN),NONE)
  ifeq ($(WOLFBOOT_SECURE_APP),1)
    ifeq ($(TARGET),stm32h5)
      $(error SIGN=NONE is incompatible with the authenticated STM32H5 secure-app handoff)
    endif
  endif
...
ifeq ($(WOLFBOOT_SKIP_BOOT_VERIFY),1)
  ifeq ($(WOLFBOOT_SECURE_APP),1)
    ifeq ($(TARGET),stm32h5)
      $(error WOLFBOOT_SKIP_BOOT_VERIFY=1 is incompatible with the authenticated STM32H5 secure-app handoff)
    endif
  endif
