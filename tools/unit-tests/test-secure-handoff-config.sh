...
expect_rejected \
    "SIGN=NONE is incompatible with the authenticated STM32H5 secure-app handoff" \
    TARGET=stm32h5 WOLFBOOT_SECURE_APP=1 SIGN=NONE

expect_rejected \
    "WOLFBOOT_SKIP_BOOT_VERIFY=1 is incompatible with the authenticated STM32H5 secure-app handoff" \
